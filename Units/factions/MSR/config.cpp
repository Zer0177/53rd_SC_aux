class cfgPatches
{
  class MSR_Misriah_Armory
  {
    ...
    requiredVersion=0.1;
    requiredAddons[]={"A3_Weapons_F_Items","ace_medical_treatment","OPTRE_Weapons_Items","A3_Weapons_F","OPTRE_Weapons_MG","OPTRE_Weapons_Pistol","OPTRE_FC_Units_Marines","A3_Characters_F_Exp_Headgear","A3_Characters_F","ace_hearing","A3_Weapons_F_Acc","A3_Weapons_F_Mark_Acc","Commando","OPTRE_Weapons_SRM77","OPTRE_Weapons_Rockets","A3_Characters_F_AoW","A3_Characters_F_Orange_Headgear","OPTRE_Weapons_Shotgun","OPTRE_Weapons_AR","OPTRE_Weapons_DMR","V_SO_Weapons","ace_fortify","A3_Characters_F_Orange","A3_Characters_F_Orange_Vests"};
  };
};
