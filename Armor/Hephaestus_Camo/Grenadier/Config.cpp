...
class cfgWeapons
{
	...
	class 53rd_U_Base_GL_uniform: haloinfmar_U_WDL_uniform
	{
		...
		scope=1;
		allowedSlots[]={901};
		displayName="[53rd] Grenadier Base ";
...
class CfgVehicles
{
	...
	class 53rd_GL_Snow_Camo_Test: 53rd_AR_base_F
	{
		scope=2;
		displayName="[53rd] Winter Grenadier";
		hiddenSelections[]=
	...
	class 53rd_GL_Woodland_Camo_Test: 53rd_AR_base_F
	{
		scope=2;
		displayName="[53rd] Woodland Grenadier";
		hiddenSelections[]=
	...
	class 53rd_GL_Urban_Camo_Test: 53rd_AR_base_F
	{
		scope=2;
		displayName="[53rd] Urban Grenadier";
		hiddenSelections[]=
	...
	class 53rd_GL_Desert_Camo_Test: 53rd_AR_base_F
	{
		scope=2;
		displayName="[53rd] Desert Grenadier";
		hiddenSelections[]=
