class CfgPatches {
	class 53rd_Hephaestus_Rifleman_MSR 
	{
			units[] = 
			{
			...
			weapons[] = 
			{
			"53rd_Hephaestus_uniform_MSR_Rifleman_Urban",
			"53rd_Hephaestus_uniform_MSR_Rifleman_Des",
			"53rd_Hephaestus_uniform_MSR_Rifleman_WDL",
			"53rd_Hephaestus_uniform_MSR_Rifleman_WTR",
			};
