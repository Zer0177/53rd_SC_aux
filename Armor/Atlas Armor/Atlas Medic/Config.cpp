...
//Armor
	class 53rd_Atlas_Specilist_Urban: Uniform_Base
	{
	...
	class 53rd_Atlas_Specilist_Snow: Uniform_Base
	{
		author="Body&Scarecrow";
		scope=2;
		scopeArsenal=2;
		side=1;
		allowedSlots[]={901};
		displayName="[53rd] Atlas SPC Armor (Snow)";
		picture="\A3\characters_f\data\ui\icon_U_BasicBody_CA.paa";
		model="\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver";
		hiddenSelections[]=
		{
...
class cfgvehicles
{
	...
	//Urban
	class 53rd_Atlas_SPC_Urban_Veh_Urban: haloinf_Marine_Soldier_base_F
	{
			scope=2;
			scopeCurator=0;
			scopeArsenal=2;
			...
			uniformClass="53rd_Atlas_Specilist_Urban";
			uniformType = "Neopren";
			linkedItems[]=
			{
		...
		//Urban
	class 53rd_Atlas_SPC_Snow_Veh_Urban: haloinf_Marine_Soldier_base_F
	{
			scope=2;
			scopeCurator=0;
			scopeArsenal=2;
			side=1;
			displayName="[53rd] Atlas Rifleman Armor (Snow)";
			hiddenSelections[]=
			{
				"Camo1",
				"Camo2",
