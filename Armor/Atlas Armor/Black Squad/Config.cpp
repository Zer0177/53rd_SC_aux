...
//Rifleman 
	class 53rd_Atlas_uniform_MSR_Black_Rifleman: Uniform_Base
	{
		...
		side=1;
		allowedSlots[]={901};
		displayName="[53rd] Atlas Black (Urban)";
		...
		class ItemInfo: UniformItem
		{
			...
			uniformType = "Neopren";
			uniformClass="53rd_Atlas_Black_Squad_Veh_Urban";
...
class cfgvehicles
{
	...
	//Urban
	class 53rd_Atlas_Black_Squad_Veh_Urban: haloinf_Marine_Soldier_base_F
	{
			scope=2;
			scopeCurator=0;
			scopeArsenal=2;
			side=1;
			displayName="[53rd] Atlas Black Rifleman Armor (Urban)";
			hiddenSelections[]=
			{
				"Camo1",
				"Camo2",
			...
			uniformClass="53rd_Atlas_uniform_MSR_Black_Rifleman";
			uniformType = "Neopren";
			linkedItems[]=
			{
