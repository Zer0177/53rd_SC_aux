...
_falcon setUserActionText [_falcongetinright, "Get in M251 Side Turret (Right) as Gunner", "<img size='1.8' img image='\a3\ui_f\data\IGUI\Cfg\Actions\getingunner_ca.paa'/>"];
...
_falcon setUserActionText [_falcongetinleft, "Get in M251 Side Turret (Left) as Gunner", "<img size='1.8' img image='\a3\ui_f\data\IGUI\Cfg\Actions\getingunner_ca.paa'/>"];
...
if ((isDedicated) OR (hasInterface && isServer)) then
{
	...
	_falconrightmg = createVehicle ["11_M251H_Turret_R", [0,0,0], [], 0, "CAN_COLLIDE"];
	_falconrightmg attachTo [_falcon, [.97,-.4,-.0]];
	_falconrightmg setDir 90;
	_falconrightmg removeWeaponGlobal "11_M251";
	_falconrightmg addWeapon "11_M251";
	_falconrightmg addMagazine "11_200rnd_20mm";
	_falconrightmg addMagazine "11_200rnd_20mm";
	_falconrightmg addMagazine "11_200rnd_20mm";
	_falconrightmg addMagazine "11_200rnd_20mm";
	_falconrightmg addMagazine "11_200rnd_20mm";
	...
	_falconleftmg = createVehicle ["11_M251H_Turret_L", [0,0,0], [], 0, "CAN_COLLIDE"];
	_falconleftmg attachTo [_falcon, [-.97,0,0]];
	_falconleftmg setDir -90;
	_falconleftmg removeWeaponGlobal "11_M251";
	_falconleftmg addWeapon "11_M251";
	_falconrightmg addMagazine "11_200rnd_20mm";
	_falconrightmg addMagazine "11_200rnd_20mm";
	_falconrightmg addMagazine "11_200rnd_20mm";
	_falconrightmg addMagazine "11_200rnd_20mm";
