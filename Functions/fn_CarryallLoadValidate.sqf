...
switch true do {
	...
	{
		_veh attachTo [_carryall,[0,-10, -4]];
		_veh setDir 180;
		_loaded = true;
	};
	...
	{
		_veh attachTo [_carryall,[0,-9, 0.8]];
		_veh setDir 180;
		_loaded = true;
	};
    ...
    {  
		_veh attachTo [_carryall,[0,-10,-1.5]];
		_veh setDir 180;
		_loaded = true;
    };
	case (_veh isKindOf "53rd_M12_FAV" or _veh isKindOf "53rd_M914_RV"):
	{
		_veh attachTo [_carryall,[0,-7.5,0.8]];  
		_loaded = true;  
	};
	...
	{
		_veh attachTo [_carryall,[0,-7.5,-1.3]];  
		_loaded = true;  
	};
...
if (_loaded) then 
{
	_carryall setVariable ["53rd_Pelican_AttachedToVehiclesEffect", [vehicle player], true];
	titleText ["-------------------------------------------<br/><t color='#ff0000' size='1.5'>MAGLOCK SUCCESSFUL!</t><br/>-------------------------------------------<br/>", "PLAIN DOWN", -1, true, true];
	playSound "FD_Finish_F";
	_carryall addEventHandler ["Killed",
	{
