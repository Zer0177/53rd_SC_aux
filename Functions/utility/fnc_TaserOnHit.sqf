...
private _narq = getText (configfile >> "CfgAmmo" >> _ammo >> "NARQ");
if((_ammo == "OPTRE_B_127x40_NARQ") || {_ammo == "OPTRE_B_8Gauge_Beanbags"} || {_ammo == "OPTRE_B_145x114_NARQ"} || {_narq == "true"} )then
{
