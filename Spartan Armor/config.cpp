	...
	class cfgWeapons
	{
		...
		hiddenSelectionsTextures[]=
			{
				"53rd_SC_aux\tex\Spartan Gear\EOD\[53rd] EOD Helmet.paa",
				"53rd_SC_aux\tex\Spartan Gear\EOD\Visor\[53rd] EOD Helmet(Visor).paa"
			};
		};
		...
		hiddenSelectionsTextures[]=
			{
				"53rd_SC_aux\tex\Spartan Gear\EOD\[53rd] EOD Helmet_Woodland.paa",
				"53rd_SC_aux\tex\Spartan Gear\EOD\Visor\[53rd] EOD Helmet(Visor).paa"
			};
		};
		...
		hiddenSelectionsTextures[]=
			{
				"53rd_SC_aux\tex\Spartan Gear\EOD\[53rd] EOD Helmet_Desert.paa",
				"53rd_SC_aux\tex\Spartan Gear\EOD\Visor\[53rd] EOD Helmet(Visor).paa"
			};
		};
		...
		hiddenSelectionsTextures[]=
			{
				"53rd_SC_aux\tex\Spartan Gear\EOD\[53rd] EOD Helmet_Winter.paa",
				"53rd_SC_aux\tex\Spartan Gear\EOD\Visor\[53rd] EOD Helmet(Visor).paa"
			};
		};
