	...
	class 53rd_Pelican: VES_D77HTCI_A
	{
		...
		class UserActions
		{
			...
			class PelLift_UnLoadVehicle
			{
				...
				displayName="<t color='#FF0000'>Release Maglock";
				displayNameDefault="<t color='#FF0000'>Release Maglock";
				onlyForPlayer=0;
				position="cargo_door_handle";
				priority=3;
				radius=5;
				showWindow=0;
				statement="0 = [this] spawn F53rd_fnc_PelicanUnLoadValidate;";
				textToolTip="<t color='#FF0000'>Release Maglock";
				userActionID=7;
			};
			class RampClose
			{
